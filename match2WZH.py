...
def getpair(img1, img2):
    ...
    rot0, rot1 = 0, 0
    img1rgb = path + 'rgb/' + img1
    img1depth = path + 'depth/' + img1
    img2rgb = path + 'rgb/' + img2
    img2depth = path + 'depth/' + img2
...
def save_picture(corners1, corners2, rgbpath1, rgbpath2, imgname):
    ...
    #cv2.imshow('img', img3)
    #cv2.waitKey(0)
    cv2.imwrite('/home/wzh/supergan/tum-data/img/'+str(imgname) + '.jpg', img)
