...
def transformxyz(path,flag_save,plyname):
    ...
    y = z_points
    z = y_points
    # newpoints = np.concatenate((x,y),axis=1)
    colors = np.asarray(temp.colors)
    aa = np.dstack((x, y, z))
    newpoints = aa.reshape(points.shape[0], points.shape[1])
    # newpoints = np.concatenate([newpoints, colors], axis=-1)
...
if __name__ == '__main__':
    ...
    # path1 = '1.ply'
    # plyname1 = "new1.ply"
    # newpoints = transformxyz(path1, flag_save, plyname1)
    # source = o3d.io.read_point_cloud(plyname1)
    # # o3d.visualization.draw_geometries([source], window_name="newpoints", width=800, height=600)
    # # temp = o3d.io.read_point_cloud(path1)
    # # points = np.asarray(temp.points)
    # temp = o3d.io.read_point_cloud("camera222dpt_rgb425-512-012701-filter.ply")#camera222dpt_rgb425-512-012701.ply
    ...
    # points = np.asarray(temp.points)
    # colors = np.asarray(temp.colors)
    # # image = o3d.io.read_image("color2.png")
    # # img = np.asarray(image)
    # # color = got_RGB("camera222dpt425-512-012701.png")
    # #https://www.yisu.com/zixun/570737.html
    # # im = Image.open("camera222dpt425-512-012701.png")
    # img = Image.open("camera222dpt425-512-012701.png")
    # w = img.width #image index out of range
    # h = img.height #image index out of range
    # im = Image.new('RGB',(w,h))
    # # for y in range(im.size[1]):
    # #     for x in range(im.size[0]):
    # #         pix_rgb = im.getpixel((x,y))
    # #         uv = np.array([[x, y]])
    # #         xyz = uv2xyz(uv, K, depth)
    #
    #
    ...
    # im.show()
    # im.save("pc2rgbcamera222dpt_rgb425-512-012701.png")
    # print("pc2rgbcamera222dpt_rgb425-512-012701",im.width,im.height)
    # #next point cloud

    temp = o3d.io.read_point_cloud("kinect2022052101_1.ply")#camera121dpt_rgb425-512-012701.ply  camera222dpt_rgb425-512-012701.ply kinect2022052101.ply
    ...
    points = np.asarray(temp.points)
    colors = np.asarray(temp.colors)
    # img = Image.open("camera222dpt425-512-012701.png")#要重新采集
    # w = img.width  # image index out of range
    # h = img.height  # image index out of range
    w=512
    h=424
    ...
    print("kinect2022052102",im.width, im.height)
