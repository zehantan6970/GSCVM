...
A brief explanation: Considering the " Matches with high confidence are selected from these dense matches and later refined to a subpixel level with a correlation-based approach"  mentioned in LoFTR's paper, the experimental results of LoFTR+Votenet are not as good as the non-dense feature point pairs found by SuperGlue+Votenet.
